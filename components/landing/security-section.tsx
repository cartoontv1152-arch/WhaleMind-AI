    ...
    <section id="security" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          {/* Title — full width */}
          <h2 aria-label="Intelligent, not reckless." className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
